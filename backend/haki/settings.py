...
WSGI_APPLICATION = 'haki.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'haki'),
...
BLOCKCHAIN = {
    ...
    'CONTRACTS': {
        'TOKEN': os.environ.get('TOKEN_CONTRACT_ADDRESS', ''),
        'ESCROW': os.environ.get('ESCROW_CONTRACT_ADDRESS', ''),
        'BOUNTY': os.environ.get('BOUNTY_CONTRACT_ADDRESS', ''),
        'REPUTATION': os.environ.get('REPUTATION_CONTRACT_ADDRESS', ''),
    }
}
